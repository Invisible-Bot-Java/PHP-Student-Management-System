			  ...
			  <div class="row">
			   ...
			   <thead>
			      <tr>
				   ...
				   $sql= "select * from student_deatil";
				   ...
				   <tbody>
		                  <tr>
							 ...
							 <td>
							 <?php echo"<a style='color: white; text-decoration: none;' href=edit_student_deatil.php?edit_student=$row[0];>"?>Edit<?php echo"</a>";?>   |
							  <a style="color: white; text-decoration: none;" href="delete_student_deatil.php?delete_student=<?php echo $row['st_id'];?>">Delete</a>
