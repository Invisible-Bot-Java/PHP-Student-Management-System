...
$image_tmp = $_FILES['image']['tmp_name'];
  ...
  if(!$image_type == 'image/jpg' or !$image_type == 'image/png' ){
	  ...
	  $size_error ="Image size is larger. Image size is should be less than 2mb";
	   ...
	   $sql ="insert into student_deatil (fname,lname,father_name,email,birthdate,mobile,gender,district,city,state,nation,photo) 
	   values('$fname','$lname','$fathername','$email','$birthdate','$mobile','$gender','$district','$city','$state','$nationality','$image')";
